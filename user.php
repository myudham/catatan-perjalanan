                ...
                <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="?url=catatan_perjalanan">
                                        ...
                                        <span>Lihat Catatan Perjalanan</span></a>
                        </li>
                        <!-- Nav Item - Tables -->
                        <li class="nav-item">
                                ...
                                <div class="container-fluid">
                                        ...
                                        <div class="mb-4 text-gray-800">
                                                ...
                                                if (!empty(@$_GET['url'])) {
                                                        ...
                                                        echo "<h5> Selamat Datang Di Aplikasi Catatan Perjalanan Berbasis Web, Aplikasi Catatan Perjalanan merupakan suatu sytem yang dapat digunakan untuk menulis dan melihat catatan. </h5>";
